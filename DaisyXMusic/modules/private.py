    ...
    client.send_message(message.chat.id,
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "📲 ABOUT", url=f"https://telegra.ph/About-Devil-Kings-Opera-Master-08-04"), 
                    InlineKeyboardButton(
                        "💬 Support", url=f"https://t.me/{SUPPORT_GROUP}")
                ],[
                    InlineKeyboardButton(
                        "😈 OWNER 😈", url=f"https://t.me/Aura_Moon1")
                ]
            ]
        ),
...
def map(pos):
    if(pos==1):
        ...
        button = [
            ...
            [InlineKeyboardButton(text = '📲 ABOUT', url=f"https://telegra.ph/About-Devil-Kings-Opera-Master-08-04"),
             InlineKeyboardButton(text = '💬 Support', url=f"https://t.me/{SUPPORT_GROUP}")],
            [InlineKeyboardButton(text = '😈 OWNER😈', url=f"https://t.me/Aura_Moon1")],
